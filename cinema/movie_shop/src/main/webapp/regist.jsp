...
<link href="${pageContext.request.contextPath}/assets/css/register.css" rel="stylesheet" type="text/css"/>
<script src="${pageContext.request.contextPath}/assets/jslib/jquery-1.7.2.min.js" type="text/javascript"></script>
<script>
var userflag = false;
var passflag = false;
var rpassflag = false;
...
$(function(){	
	...
	function checkUsername(){
		...
		// 3.打开连接
		xhr.open("GET","${pageContext.request.contextPath}/userfront/byname?username="+username,true);
		// 4.发送
		xhr.send(null);
	}
    ...
    function loadImage(){
    	$("#randImage").attr("src","image.jpg?"+Math.floor(Math.random()*100));
    }
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${ pageContext.request.contextPath }/userfront/regist"  method="post" novalidate="novalidate" onsubmit="return checkForm();">
						<table>
							<tbody><tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="password" id="password" name="password" class="text" maxlength="20" autocomplete="off" onblur="checkUsername()" />
									<span id="span1"></span>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input id="repassword" type="password" name="repassword" class="text" maxlength="20" autocomplete="off" onblur="checkUsername()"/>
									<span id="span1"></span>
								</td>
							</tr>
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"><img onClick="javascript:loadImage();"  title="换一张试试" id="randImage" 
				 src="image.jpg"  width="95" style="border:1px solid #CCC;" />
...
<div class="ad">
	...
	<dd>
		自由退换、售后上门
								...
								<dd>
									立即登录即可体验在线购物！
									<a href="${pageContext.request.contextPath}/userfront/login">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
