				...
				<table>
					...
					<tr>
						...
						<c:forEach items="${orders.orderItems}" var="orderItem">
							<tr>
								<td width="60">
									<img src="${ pageContext.request.contextPath }/upload/${orderItem.movie.mimage}"/>
								</td>
								<td>
									${orderItem.movie.mname}
								</td>
								<td>
									${orderItem.movie.shopprice}
								</td>
			...
			<form id="orderForm" action="${ pageContext.request.contextPath }/payorder" method="post">
				...
				<div class="span24">
					<p>	
						...
						<p>
							选择银行：<br/>
							<input type="radio" name="pd_FrpId1" value="ICBC-NET-B2C" checked="checked"/>工商银行
							<img src="${ pageContext.request.contextPath }/assets/bank_img/icbc.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="pd_FrpId1" value="BOC-NET-B2C"/>中国银行
							<img src="${ pageContext.request.contextPath }/assets/bank_img/bc.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="pd_FrpId1" value="ABC-NET-B2C"/>农业银行
							<img src="${ pageContext.request.contextPath }/assets/bank_img/abc.bmp" align="middle"/>
							<br/>
							<input type="radio" name="pd_FrpId1" value="BOCO-NET-B2C"/>交通银行
							<img src="${ pageContext.request.contextPath }/assets/bank_img/bcc.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="pd_FrpId1" value="PINGANBANK-NET"/>平安银行
							<img src="${ pageContext.request.contextPath }/assets/bank_img/pingan.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="pd_FrpId1" value="CCB-NET-B2C"/>建设银行
							<img src="${ pageContext.request.contextPath }/assets/bank_img/ccb.bmp" align="middle"/>
							<br/>
							<input type="radio" name="pd_FrpId1" value="CEB-NET-B2C"/>光大银行
							<img src="${ pageContext.request.contextPath }/assets/bank_img/guangda.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="pd_FrpId1" value="CMBCHINA-NET-B2C"/>招商银行
							<img src="${ pageContext.request.contextPath }/assets/bank_img/cmb.bmp" align="middle"/>
						</p>
						<hr />
						<p style="text-align:right">
							<a href="javascript:document.getElementById('orderForm').submit();">
								<img src="${pageContext.request.contextPath}/assets/images/finalbutton.gif" width="204" height="51" border="0" />
							</a>
						</p>
				</div>
			</form>
